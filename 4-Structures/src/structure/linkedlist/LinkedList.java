...
public class LinkedList {
    ...
    /**
     * Inserts the given person to the end of the list.
     *
     * @param person the person instance to be added
     */
    ...
    /**
     * Inserts the given person at the given index, so the new person
     * will be at the given index AFTER the insertion is done.
     * To insert person 'p' at index 'i', this function first gets a
     * reference like 'r' to the node at index 'i' - 1, creates a new
     * node with person 'p' and sets its next to 'r'.next. Then sets
     ...
     *
     * @param person the person instance to be added
     * @param index the index at which {@param person} is inserted
    ...
    /**
     * Returns the person (of the node) at given index.
     *
     * @param index index of (node of) the wanted person in the list
     * @return Person instance of the node at given index
     */
    ...
    /**
     * Returns the last (node's) person in the list.
     *
     * @return Person instance of the last node in the list
     */
    public Person get() {
